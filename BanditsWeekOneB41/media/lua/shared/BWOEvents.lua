...
-- params: []
BWOEvents.Start2ClockingIn = function(params)
    getPlayer(0).Say(getPlayer(0), "hello world test of Start2ClockingIn...") 
    local player = getSpecificPlayer(0)
    ...
    if building then
        ...
        local args = {id=keyId, event="home2", x=(buildingDef:getX() + buildingDef:getX2()) / 2, y=(buildingDef:getY() + buildingDef:getY2()) / 2}
